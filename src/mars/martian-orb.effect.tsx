  ...
  useEffect(() => {
    ...
    function render(timestamp: number): void {
      ...
      gl.uniform1f(
        ...
        (current.axialTilt * Math.PI) / 180,
      )
      gl.uniform1f(gl.getUniformLocation(resources.program, 'uBlueAureole'), current.blueAureole)
      gl.uniform1f(gl.getUniformLocation(resources.program, 'uDustAerosol'), current.dustAerosol)
      gl.uniform1f(gl.getUniformLocation(resources.program, 'uDustDetail'), current.dustDetail)
